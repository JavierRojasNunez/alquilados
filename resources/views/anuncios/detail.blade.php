...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-4">
            <a data-fancybox="gallery" id="galeria"
                href="{{ route('image.file', ['id'=> $anuncio->user_id, 'filename'=> $imagenes->imageName ]) }}"
    ...
    <div class="row">
        ...
        <div class="col-10 detail">
            <div class="data-1">
                <span class="price-detail">{{$anuncio->price}} € </span> <span
                    class="city">{{$anuncio->city_rent}}</span> - <b>{{$anuncio->province_rent}}</b> -
                {{$anuncio->type_rent}} en {{$anuncio->type}} {{$anuncio->payment_period}}
            </div>

            <div class="data-2">
                Situada en {{$anuncio->street_rent}} {{$anuncio->adress_rent}} nº{{$anuncio->num_street_rent}}
                &nbsp;&nbsp;&nbsp; Piso: {{$anuncio->flat_street_rent}} &nbsp; &nbsp;&nbsp;cp {{$anuncio->cp_rent}}
                &nbsp; {{$available}}
            </div>
            <div class="d-flex p-1 data-caracteristicas">
                <img src="../../icons/dormitorio.png" class="icons-small" title="Dormitorios" alt="Dormitorios"> &nbsp;
                {{$anuncio->num_rooms}}
                &nbsp; &nbsp; &nbsp;
                <img src="../../icons/bath.png" class="icons-small" title="Baños" alt="Baños"> &nbsp;
                {{$anuncio->num_baths}}
                &nbsp; &nbsp; &nbsp;
                <img src="../../icons/superficie.png" class="icons-small" title="Superficie" alt="Superficie"> &nbsp;
                {{$anuncio->meter2}} m&sup2;

            </div>
            <div class="d-flex p-1 data-caracteristicas">

                <a href=""><img src="../../icons/phone.png" class="icons-small contact" id="anouce_phone"
                        title="Télefono" alt="Télefono"></a>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                <a href=""><img src="../../icons/email.png" id="anouce_phone" class="icons-small contact" title="Email"
                        alt="Email"></a>
            </div>
